...
const testimonials = [
  {
    content: "توسعه صرافی غیر متمرکز و امنیت و بازرسی آن توسط تیم تکنوژن، تجربه‌ای بی‌نظیر بود. تخصص و تعهد ما به کیفیت باعث ساخت پروژه هایی خاص و موفق بود.",
  },
  {
    content: "پروژه رمز ارزی Axora protocol که توکنی با قابلیت استیکینگ و فروش اولیه بود توسط تیم تکنوژن توسعه یافت. همکاری با آن‌ها بسیار حرفه‌ای و نتیجه‌محور بود، و ما از نتیجه نهایی بسیار راضی هستیم.",
  },
  {
  ...
  {
    content: " اولین بار در ایران اقدام به توسعه ابزار های اختصاصی برای امنیت قرارداد هوشمند کردیم که بازرسی قرارداد هوشمند و تامین امنیت ان را برای تیم ما بسیار آسان می ",
  },
  {
